...
async function main() {
  ...
  const directorsConfig = [
    { code: 'DG_OFFICE', username: 'dir_office', name: 'أ. سامي المرعي', title: 'مدير مكتب المدير العام', email: 'office@ports.gov.sy' },
    { code: 'IMSAS', username: 'dir_imsas', name: 'ربان. نزار محمود', title: 'رئيس مكتب تدقيق IMO/IMSAS', email: 'imsas@ports.gov.sy' },
    { code: 'PSC', username: 'dir_psc', name: 'م. هيثم صقر', title: 'مدير رقابة دولة الميناء', email: 'psc@ports.gov.sy' },
    { code: 'PLANNING', username: 'dir_planning', name: 'د. باسل سلوم', title: 'مدير التخطيط والإحصاء', email: 'planning@ports.gov.sy' },
    { code: 'PR', username: 'dir_pr', name: 'أ. هناء عثمان', title: 'مديرة العلاقات العامة', email: 'pr@ports.gov.sy' },
    { code: 'TARTOUS_BRANCH', username: 'dir_tartous', name: 'ربان. غياث إبراهيم', title: 'مدير فرع طرطوس', email: 'tartous@ports.gov.sy' },
    { code: 'INTERNAL_AUDIT', username: 'dir_audit', name: 'أ. طارق الشيخ', title: 'مدير الرقابة الداخلية', email: 'audit@ports.gov.sy' },
    { code: 'SUPPLY', username: 'dir_supply', name: 'م. كنان ديوب', title: 'مدير الدعم والتوريد', email: 'supply@ports.gov.sy' },
    { code: 'MORAL_GUIDANCE', username: 'dir_moral', name: 'أ. رامي حيدر', title: 'رئيس مكتب التوجيه المعنوي', email: 'moral@ports.gov.sy' },
    { code: 'MARITIME_EDU', username: 'dir_edu', name: 'قبطان. ماهر سليمان', title: 'مدير التعليم والتأهيل البحري', email: 'edu@ports.gov.sy' },
    { code: 'FINANCE', username: 'dir_finance', name: 'أ. منذر العلي', title: 'مدير المالية', email: 'finance@ports.gov.sy' },
    { code: 'INSPECTION', username: 'dir_inspection', name: 'ربان. كمال نجار', title: 'مدير التفتيش البحري', email: 'inspection@ports.gov.sy' },
    { code: 'MAINTENANCE', username: 'dir_maintenance', name: 'م. وائل حداد', title: 'مدير المنشآت والصيانة', email: 'maintenance@ports.gov.sy' },
    { code: 'FISHERIES_LICENSES', username: 'dir_fisheries', name: 'أ. مازن يونس', title: 'مدير المصائد والرخص', email: 'fisheries@ports.gov.sy' },
    { code: 'INFORMATICS', username: 'dir_informatics', name: 'م. لمى زريق', title: 'مديرة المعلوماتية', email: 'informatics@ports.gov.sy' },
    { code: 'IT_INFRA', username: 'dir_it', name: 'م. فادي حبيب', title: 'مدير تقانة المعلومات', email: 'it@ports.gov.sy' },
    { code: 'VEHICLES', username: 'dir_vehicles', name: 'م. جهاد علي', title: 'مدير الآليات', email: 'vehicles@ports.gov.sy' },
    { code: 'ADMIN_DEV', username: 'dir_admin_dev', name: 'د. ياسمين شاهين', title: 'مديرة التنمية الإدارية', email: 'admin.dev@ports.gov.sy' },
    { code: 'LEGAL', username: 'dir_legal', name: 'أ. ريم منصور', title: 'مديرة الشؤون القانونية', email: 'legal@ports.gov.sy' },
    { code: 'PORT_AFFAIRS', username: 'dir_ports', name: 'م. غسان يوسف', title: 'مدير شؤون الموانئ', email: 'ports@ports.gov.sy' },
  ];
